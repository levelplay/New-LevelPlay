...
const AppToast = () => {
  ...
  return (
    <>
      <div
        id="toast-success"
        className="flex items-center max-w-full w-fit px-3 py-2 pr-4 gap-3 text-gray-500 bg-white rounded-lg shadow-md fixed bottom-6 left-6 scale-0 opacity-0 aria-checked:scale-100 aria-checked:opacity-100 duration-100 z-[1000000]"
